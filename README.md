# CommonFIRE organization profile

`profile/README.md` is displayed on the CommonFIRE organization overview.
...
The profile banner follows the viewer's light/dark preference. Organization avatars must be uploaded separately through GitHub settings.
